...
<div class="edit-container">
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" id="taskName" class="form-control" placeholder="Enter task name" value="<?= $tasks['title']?>">
        </div>
        <div class="form-group">
            ...
            <select id="taskStatus" class="form-select" required>
                ...
                <option value="Progress"<?= $tasks['status'] == 'in_progress' ? 'selected': ''?>>In progress</option>
            </select>
        </div>
        <div class="form-group">
